...
```hcl
resource "sys11iam_organization_project_s3_user_key" "test_terraform_organization_project_s3_user_key" {
  count = data.sys11iam_organization.testorg.is_active ? 1 : 0
  s3_user_id = sys11iam_organization_project_s3_user.test_terraform_organization_project_s3user[0].id
...
```hcl
import {
    to = sys11iam_organization_project_s3_user_key.test_terraform_organization_project_s3_user_key[0]
