...
```bash
terraform import sys11iam_organization_serviceaccount.test_serviceaccount[0] <org_id,service_account_id>
```

Where `org_id` is the ID of the organization and `service_account_id` is the ID of the organization service account you want to import.
