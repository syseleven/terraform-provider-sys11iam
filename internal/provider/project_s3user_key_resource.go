...
import (
	...
	"github.com/syseleven/terraform-provider-sys11iam/internal/resource_project_s3user_key"
)
...
func (r *ProjectS3UserKeyResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_project_s3user.ProjectS3UserKeyResourceSchema(ctx)
}
...
func (r *ProjectS3UserKeyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_project_s3user_key.ProjectS3UserKeyModel
...
func (r *ProjectS3UserKeyResource) ImportState(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	response, err := r.client.GetProjectS3UserKey(data.OrganizationId.ValueString(), data.ProjectId.ValueString(), data.S3UserId.ValueString(), data.KeyId.ValueString())
	if err != nil {
		resp.Diagnostics.AddError("", err.Error())
		return
	}
...
func (r *ProjectS3UserKeyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.DeleteProjectS3UserKey(data.OrganizationId.ValueString(), data.ProjectId.ValueString(), data.S3UserId.ValueString(), data.KeyId.ValueString())
	if err != nil {
		resp.Diagnostics.AddError("", err.Error())
		return
	}
